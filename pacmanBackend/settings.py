"""
Django settings for pacmanBackend project.
...
SECRET_KEY = 'django-insecure-9!ueq$2pn$*w1$p=hr2_r!5o9nfl9tc=266dzq339it1k^%z%-'
...
ROOT_URLCONF = 'pacmanBackend.urls'
...
WSGI_APPLICATION = 'pacmanBackend.wsgi.app'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:3000",
    "http://localhost:8080",
    "https://pacman-app4.vercel.app",
    "https://pacman-app5.vercel.app"
]
...
STATIC_ROOT =  os.path.join(BASE_DIR, 'static_build','staticfiles')
MEDIA_URLS = '/media/'
